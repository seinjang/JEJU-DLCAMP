...
class ImageInput(object):
    ...
    def set_shapes(self, batch_size, images, questions, labels,
        ...
        if self.transpose_input:
            ...
            places.set_shape(places.get_shape().merge_with(
                tf.TensorShape([batch_size, None, 10])))
    ...
    def dataset_parser(self, value):
        ...
        num_place = tf.one_hot(parsed['image/places/number'], 10)
    ...
    def input_fn(self,params):
        ...
        features['question'] = tf.concat([features['keyword'], features['center'], features['boundary'],
                            tf.concat([features['place'][:,0,:], features['place'][:,1,:]], 1),
                            features['num_place']], 1)
