...
flags.DEFINE_integer(
    'train_batch_size', default=100, help='Batch size for training.')

flags.DEFINE_integer(
    'eval_batch_size', default=100, help='Batch size for evaluation.')

flags.DEFINE_integer(
    'num_train_images', default=1216, help='Size of training data set.')
...
def resnet_model_fn(features, labels, mode, params):
    ...
    feature_image -= tf.constant(MEAN_RGB, shape=[1, 1, 3], dtype=feature_image.dtype)
    feature_image /= tf.constant(STDDEV_RGB, shape=[1, 1, 3], dtype=feature_image.dtype)
    ...
    logits = relation_network(image_feature_maps, feature_question)
